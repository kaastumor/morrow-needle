...
SOURCE_METADATA_TAGS = {"BIB.DOC", "BIB.INSTANCE", "BIB.INSTANCE.CONS", "NO.CELEX", "FMX", "PUBLICATION.REF", "FAM.COMP"}
SOURCE_METADATA_CONTAINERS = {"DOC"}
    ...
    def _walk_structures(
        ...
        *,
        ...
        for child in list(element):
            ...
            elif tag in SOURCE_METADATA_CONTAINERS and not _has_structural_descendant(child):
                category = "SOURCE_METADATA"
